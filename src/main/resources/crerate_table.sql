...
CREATE TABLE CONTRACTS( 
  ...
  , STAFF_NO VARCHAR2(36) NOT NULL
  , IS_INVALID NUMBER(1, 0) DEFAULT 0 NOT NULL
...
comment on column CONTRACTS_TRAN.STAFF_SUB_NO is 'スタッフ履歴No';
comment on column CONTRACTS_TRAN.BILL_ADDRESS_ID is '請求先ID';
...
CREATE TABLE STAFFS_DETAILS( 
  STAFF_NO VARCHAR(36) NOT NULL
  , SUB_NO CHAR(3) NOT NULL
  , SKILLS VARCHAR2(600)
  , JOB_POSITION_CD CHAR(2)
  , MONTHLY_PAY_AMOUNT NUMBER(5, 2) DEFAULT 0 NOT NULL
  , BONUS_AMOUNT NUMBER(5, 2) DEFAULT 0 NOT NULL
  , SALES_STAFF_NO VARCHAR2(5)
  , REMARKS VARCHAR2(800)
  , IS_INVALID NUMBER(1, 0) DEFAULT 0 NOT NULL
  , UPDATER_ID VARCHAR2(10)
  , UPDATED_AT DATE
  , CREATER_ID VARCHAR2(10) NOT NULL
  , CREATED_AT DATE NOT NULL
  , CONSTRAINT PK_STAFFS_DETAILS PRIMARY KEY (STAFF_NO, SUB_NO)
); 

comment on table STAFFS_DETAILS is 'スタッフ詳細マスタ';
comment on column STAFFS_DETAILS.STAFF_NO is 'スタッフNo';
comment on column STAFFS_DETAILS.SUB_NO is '履歴No';
comment on column STAFFS_DETAILS.SKILLS is '主要技術';
comment on column STAFFS_DETAILS.JOB_POSITION_CD is '職位CD';
comment on column STAFFS_DETAILS.MONTHLY_PAY_AMOUNT is '給与額';
comment on column STAFFS_DETAILS.BONUS_AMOUNT is '賞与額';
comment on column STAFFS_DETAILS.SALES_STAFF_NO is '担当営業No';
comment on column STAFFS_DETAILS.REMARKS is '備考';
comment on column STAFFS_DETAILS.IS_INVALID is '無効フラグ';
comment on column STAFFS_DETAILS.UPDATER_ID is '更新者';
comment on column STAFFS_DETAILS.UPDATED_AT is '更新年月日';
comment on column STAFFS_DETAILS.CREATER_ID is '登録者';
comment on column STAFFS_DETAILS.CREATED_AT is '登録年月日';
...
comment on column BILL_ADDRESSES.ADDRESS1 is '住所１';
comment on column BILL_ADDRESSES.ADDRESS2 is '住所２';
...
comment on column BILL_ADDRESSES.BILL_ADDRESS_NAME is '請求先管理名';
